...
set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_SERVER_NAME_UPPERCASE}_PACKAGE_DEPENDS "${IRODS_PACKAGE_DEPENDENCIES_STRING}, irods-runtime (= ${CPACK_DEBIAN_PACKAGE_VERSION}), irods-icommands (= ${CPACK_DEBIAN_PACKAGE_VERSION}), libc6, sudo,libfuse2, python, openssl, python-psutil, python-requests, lsof")
